...
function InventoryPage({ userRole }) {
  ...
  // Fetch ALL items at once (limit 5000) for client-side search fix:
  const { inventory: allInventory, totalItems, isLoading, error, refetchData } = useFetchInventory({ limit: 5000, offset: 0 });
