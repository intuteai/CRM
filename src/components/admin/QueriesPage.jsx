                ...
                {filteredQueries.map((query) => (
                  <React.Fragment key={query.queryId}>
                    <tr className="hover:bg-navy-50/60 transition-colors">
                      ...
                      <td className="px-5 py-3.5 text-gray-600 min-w-[140px] lg:min-w-0">{query.customerName || 'N/A'}</td>
                      <td className="px-5 py-3.5 text-gray-600 min-w-[220px] lg:min-w-0">{query.description}</td>
      ...
      {showConfirmDialog && (
        <div className="fixed inset-0 bg-navy-900/50 flex items-center justify-center z-50 p-4">
          <div className="bg-white p-6 rounded-xl shadow-2xl w-full max-w-md max-h-[90vh] overflow-y-auto relative">
            ...
            <h2 className="font-display text-xl font-bold text-navy-800 mb-4">
              Confirm Close
            </h2>
