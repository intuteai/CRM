...
import {
  Truck, FileText, MessageSquare, DollarSign, Mail, Package, MapPin
} from 'lucide-react';

function SalesDashboard({ socket }) {
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-gray-100 p-6">
      <h1 className="text-3xl font-bold text-gray-800 mb-10 text-center tracking-tight">Sales Dashboard</h1>
      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <Section title="Inventory & Pricing">
          <DashboardCard to="/inventory" icon={<Package />} title="Inventory" desc="View finished goods inventory" />
          <DashboardCard to="/price-list" icon={<DollarSign />} title="Price List" desc="Access product pricing" />
        </Section>
